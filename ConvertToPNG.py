...
PATH = r'/home/ubuntu/Capstone/Autoencoder/Nairobi/TIF'
PATH_PNG = r'/home/ubuntu/Capstone/Autoencoder/Nairobi/PNG/Train/nairobi_clipped_{}_.png'

i=0
for filename in os.listdir(PATH.format(IMAGE)):

    path = PATH.format(IMAGE)+ '/' +  filename


    print(path)
    tmp_image = convert_to_PNG(path)
    tmp_image.save(PATH_PNG.format(IMAGE, filename))
    i = i + 1
