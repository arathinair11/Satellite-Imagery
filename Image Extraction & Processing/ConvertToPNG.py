...
""" =================================== Convert into 10 x 10 PNG images ============================================ """
...
parent_dir = '/home/ubuntu/Autoencoder/'
name = 'Lagos'
...
PATH = f'/home/ubuntu/Autoencoder/{name}/TIF'
PATH_PNG = f'/home/ubuntu/Autoencoder/{directory}/'+f'{name}' + '_clipped_{}_.png'
