...
source1 = '/Users/arathi/Desktop/Pycharm/Autoencoder/Lagos/Labeled/PNG/Train'
...
class Decoder(nn.Module):
    ...
    def __init__(self, encoded_space_dim):
        ...
        self.decoder_lin = nn.Sequential(
            ...
            nn.ReLU(True),
            nn.Linear(100, 2 * 2 * 64),
            nn.ReLU(True)
        )
        self.unflatten = nn.Unflatten(dim=1,
        unflattened_size=(64, 2, 2))
...
optimizer = torch.optim.AdamW(params_to_optimize, lr=lr,weight_decay=1e-5)
...
def training(dataloader, num_epochs):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        torch.save(encoder.state_dict(), '/Users/arathi/Desktop/Pycharm/Autoencoder/Lagos/Labeled/PATH/enoder_autoencoder.pth')
        torch.save(decoder.state_dict(), '/Users/arathi/Desktop/Pycharm/Autoencoder/Lagos/Labeled/PATH/decoder_autoencoder.pth')
...
plt.legend()
plt.show()
plt.savefig('/Users/arathi/Desktop/Pycharm/Autoencoder/Lagos/Labeled/PATH/train_ae__loss.png')
...
output = decoded_data.detach().numpy()
