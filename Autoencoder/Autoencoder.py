...
source1 = '/home/ubuntu/Capstone/Satellite_Images/Train'
...
def training(dataloader, num_epochs):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        torch.save(encoder.state_dict(), '/home/ubuntu/Capstone/Path/enoder_autoencoder.pth')
        torch.save(decoder.state_dict(), '/home/ubuntu/Capstone/Path/decoder_autoencoder.pth')
...
plt.legend()
plt.show()
plt.savefig('/home/ubuntu/Capstone/Path/train_ae__loss.png')
