...
root = '/home/ubuntu/Autoencoder/Autoencoder/Labeled/Train'
test = '/home/ubuntu/Autoencoder/Autoencoder/Labeled/Test'
...
checkpoint = torch.load('/home/ubuntu/Autoencoder/Autoencoder/Labeled/Model/Path32/enoder_autoencoder.pth', map_location=torch.device('cpu'))
...
confusion_matrix_df = pd.DataFrame(confusion_matrix(y_true_list, y_pred_list)).rename(columns={'0':'Built-Up','1': 'Deprived'})#, index=idx2class)
