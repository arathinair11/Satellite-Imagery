...
def training(dataloader, num_epochs):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        #
        torch.save(encoder.state_dict(), '/home/ubuntu/Autoencoder/Final/Path/cnn_encoder_autoencoder.pth')
        torch.save(decoder.state_dict(), '/home/ubuntu/Autoencoder/Final/Path/cnn_decoder_autoencoder.pth')
...
plt.legend()
plt.show()
plt.savefig('/home/ubuntu/Autoencoder/Final/Path/cnn_train_ae__loss.png')
...
plt.show()
plt.savefig('/home/ubuntu/Autoencoder/Final/Path/CNN_Original10.png')
...
plt.show()
plt.savefig('/home/ubuntu/Autoencoder/Final/Path/CNN_Reconstructed10.png')
