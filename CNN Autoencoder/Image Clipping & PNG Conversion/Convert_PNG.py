...
PATH = r'/home/ubuntu/Capstone/Autoencoder/Lagos/Labeled/Tiff'

PATH_PNG = r'/home/ubuntu/Capstone/Autoencoder/Lagos/Labeled/PNG/clipped_{}.png'
...
for filename in os.listdir(PATH):
    ...
    tmp_image.save(PATH_PNG.format(i))
    i = i + 1
