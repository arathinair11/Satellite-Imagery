...
source1 = r'/home/ubuntu/Capstone/Autoencoder/Lagos/Unlabeled/PNG'
...
def save_decod_img(img, epoch):
    ...
    save_image(img, '/home/ubuntu/Capstone/Autoencoder/Lagos/Unlabeled/Model_Images/Autoencoder_image{}.png'.format(epoch))
...
def training(model, dataloader, num_epochs):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        torch.save(model.state_dict(), '/home/ubuntu/Capstone/Autoencoder/Lagos/Unlabeled/Path/conv_autoencoder.pth')
    return train_loss
...
plt.legend()
plt.show()
plt.savefig('/home/ubuntu/Capstone/Autoencoder/Lagos/Unlabeled/train_ae__loss.png')
